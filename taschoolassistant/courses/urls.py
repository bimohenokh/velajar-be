...
from .views import (
    ...
    CourseSessionFeatureViewById, MyParticipantPointView,
)
...
urlpatterns = [
    ...
    path("<int:course_id>/participant-points/me/", MyParticipantPointView.as_view(), name="my-participant-point"),
    path("<int:course_id>/sessions/", CourseSessionView.as_view(), name="course-session"),
    path("sessions/<int:session_id>/", CourseSessionViewById.as_view(), name="course-session-id"),
